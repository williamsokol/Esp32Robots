...
/**************************************************************************/
/*!
    @brief  Gets the Adafruit_sensor_t data for the MPU6050's gyroscope sensor
*/
/**************************************************************************/
void Adafruit_MPU6050_Gyro::getSensor(Adafruit_sensor_t *sensor) {
...
/**************************************************************************/
/*!
    @brief  Gets the Adafruit_sensor_t data for the MPU6050's accelerometer
*/
/**************************************************************************/
void Adafruit_MPU6050_Accelerometer::getSensor(Adafruit_sensor_t *sensor) {
  /* Clear the Adafruit_sensor_t object */
  memset(sensor, 0, sizeof(Adafruit_sensor_t));
...
/**************************************************************************/
/*!
    @brief  Gets the Adafruit_sensor_t data for the MPU6050's tenperature
*/
/**************************************************************************/
void Adafruit_MPU6050_Temp::getSensor(Adafruit_sensor_t *sensor) {
  /* Clear the Adafruit_sensor_t object */
  memset(sensor, 0, sizeof(Adafruit_sensor_t));
